...
import 'content/text_content_entry_page.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ConstrainedBox(
              ...
              child: const BubbleText(
                text: '1121212ssasasasasassaa',
                bgColor: Colors.red,
                maxLines: 1,
              ),
            ),
            const InsertInfo(infoText: '1121212ssasasasasassaa'),
            ConstrainedBox(
              constraints: BoxConstraints.loose(const Size.fromWidth(80)),
              child: const InsertInfo(infoText: '1121212ssasasasasassaa'),
            ),
            EnhanceNumberCard(
              itemChildren: [
                NumberInfoItemModel(number: '3', preDesc: '前', lastDesc: '后'),
                NumberInfoItemModel(number: '3', preDesc: '前', lastDesc: '后')
              ],
            ),
            RichInfoGrid(
