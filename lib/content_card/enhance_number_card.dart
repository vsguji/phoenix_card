...
class BrnEnhanceNumberCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    EnhanceNumberCardConfig defaultConfig =
        themeData ?? EnhanceNumberCardConfig();

    defaultConfig = defaultConfig.merge(EnhanceNumberCardConfig(
  ...
  Widget _getPreWidget(String? preDesc, EnhanceNumberCardConfig config) {
  ...
  Widget _getLastWidget(String? lastDesc, EnhanceNumberCardConfig config) {
